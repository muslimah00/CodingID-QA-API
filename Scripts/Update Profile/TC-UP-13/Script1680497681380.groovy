...
String uploadFileName = 'bigpic.png'

File file = new File(RunConfiguration.getProjectDir(), uploadFilePath + uploadFileName)

println(file.getAbsolutePath())

updateProfileResponse = WS.sendRequest(findTestObject('Postman/Update Profile', [('whatsapp') : '1234567890', ('birth_date') : '1995-05-04'
            , ('photo') : 'C:\\Users\\ACER\\Pictures\\ProfilePic.jpg', ('bio') : 'Software Dev', ('position') : 'mobile dev'
